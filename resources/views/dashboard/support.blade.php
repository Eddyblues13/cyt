        ...
        <div class="pt-[66px] pb-[63px]">
            ...
            <nav class="topnav-user fixed w-[100%] top-0 border-gray-200 bg-binance z-[5] max-w-[480px] mx-auto">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-4">
                    ...
                    <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <a class="flex text-[20px] md:me-0 z-10" href="">
            ...
            <div class="container mx-auto px-[8px]">
                <div class="px-[6px]">
                    <h1 class="text-[14px] text-gray-400 mb-3">Contact</h1><a href="" target="_blank"
                        class="flex items-center gap-2 text-white hover:text-gray-400 border border-gray-700 px-2 rounded-[6px] font-semibold text-[16px] py-2.5 my-1">
                        <h1 class="flex-auto">Telegram</h1><i
                            class="fi fi-sr-angle-right text-gray-400 text-[12px] leading-[0px]"></i>
                    </a>
                    <a href="mailto:http://127.0.0.1:8000/dashboard/settings"
                        class="flex items-center gap-2 text-white hover:text-gray-400 border border-gray-700 px-2 rounded-[6px] font-semibold text-[16px] py-2.5 my-1">
                        <h1 class="flex-auto">Email</h1>
                        <i class="fi fi-sr-angle-right text-gray-400 text-[12px] leading-[0px]">
                        </i>
                    </a>
                </div>
            </div>
