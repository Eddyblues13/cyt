...
<head>
    ...
    <meta name="csrf-token" content="uP4IujMCBe62V8JZUzmYrv9j6lQdk53y34SHo8I9">
        ...
        <div class="pt-[66px] pb-[63px]">
                    ...
                    <ul class="space-y-2 font-medium">
                        <li>
                            ...
                            <form id="logout-form" action="https://app.tradefortunesphere.cc/logout" method="POST"
                                style="display: none;">
                                <input type="hidden" name="_token" value="uP4IujMCBe62V8JZUzmYrv9j6lQdk53y34SHo8I9">
                            </form>
            ...
            <div id="kycPopup"
                ...
                <div class="bg-gray-800 p-8 rounded-lg max-w-md w-full mx-4">
                    ...
                    <p class="text-gray-300 mb-6">Your account is not verified. Complete KYC to unlock
                        all
                        features
                        and enhance your trading experience.</p>
            ...
            <div class="container mx-auto px-[8px]">
                <a class="border border-gray-700 rounded-xl p-4 flex items-center mb-2" href="/deposit/16">
                    <div class="pe-3"><i class="fi fi-sr-inbox-in text-gray-300"></i></div>
                    <div class="flex-auto">
                        <h1 class="text-sm text-gray-300">USDT TRC20</h1>
                        <h1 class="text-[10px] text-gray-500">Deposit with: USDT</h1>
                    </div>
                    <div class="mt-1"><i class="fi fi-sr-angle-small-right text-gray-500"></i></div>
                </a>
                <a class="border border-gray-700 rounded-xl p-4 flex items-center mb-2" href="/deposit/17">
                    <div class="pe-3"><i class="fi fi-sr-inbox-in text-gray-300"></i></div>
                    <div class="flex-auto">
                        <h1 class="text-sm text-gray-300">BTC BTC</h1>
                        <h1 class="text-[10px] text-gray-500">Deposit with: BTC</h1>
                    </div>
                    <div class="mt-1"><i class="fi fi-sr-angle-small-right text-gray-500"></i></div>
                </a>
                <a class="border border-gray-700 rounded-xl p-4 flex items-center mb-2" href="/deposit/18">
                    <div class="pe-3"><i class="fi fi-sr-inbox-in text-gray-300"></i></div>
                    <div class="flex-auto">
                        <h1 class="text-sm text-gray-300">Eth ETH NETWORK</h1>
                        <h1 class="text-[10px] text-gray-500">Deposit with: Eth</h1>
                    </div>
                    <div class="mt-1"><i class="fi fi-sr-angle-small-right text-gray-500"></i></div>
                </a>
            </div>
            ...
            <div class="btm-nav bottomnav-user bg-binance z-[5] max-w-[480px] mx-auto">
                ...
                <a class="text-gray-400 bg-binance" href="/panel">
